...
import '../widgets/page_views/categories_screen_view.dart';
export '../widgets/page_views/categories_screen_view.dart';

/// Public page boundary for [CategoriesView].
///
...
/// ```
class CategoriesScreen extends CategoriesView {
