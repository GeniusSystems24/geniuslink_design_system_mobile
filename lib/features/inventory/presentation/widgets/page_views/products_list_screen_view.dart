...
/// Renders the presentation for [ProductsListScreen].
///
...
class ProductsListView extends StatefulWidget {
  ...
  @override
  State<ProductsListView> createState() => _ProductsListScreenState();
}

class _ProductsListScreenState extends State<ProductsListView> {
  ...
  Widget build(BuildContext context) {
    final categories = <String>{
      'All',
      ...widget.products.map((p) => p.category),
    }.toList();
