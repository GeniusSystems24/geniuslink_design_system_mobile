...
/// Renders the presentation for [BarcodePrintScreen].
///
...
///
/// ```dart
/// const BarcodePrintView()
/// ```
class BarcodePrintView extends StatefulWidget {
  const BarcodePrintView({super.key});
  @override
  State<BarcodePrintView> createState() => _BarcodePrintScreenState();
}

class _BarcodePrintScreenState extends State<BarcodePrintView> {
  String _tpl = 'md';
  @override
