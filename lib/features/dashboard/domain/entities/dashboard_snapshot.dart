...
class CashFlowPoint extends Equatable {
  ...
  const CashFlowPoint({required this.period, required this.inflow, required this.outflow});
  @override
...
class AccountBalanceSummary extends Equatable {
  ...
  const AccountBalanceSummary({required this.code, required this.name, required this.amount, required this.sharePercent});
  @override
...
class RecentOperation extends Equatable {
  ...
  const RecentOperation({required this.reference, required this.description, required this.amount, required this.timeLabel});
...
class DashboardAlert extends Equatable {
  ...
  final String title;
  final String description;
  const DashboardAlert({required this.type, required this.title, required this.description});
  @override
...
class DashboardSnapshot extends Equatable {
  ...
  @override
  List<Object?> get props => [periodLabel, kpis, cashFlow, balances, recentOperations, alerts];
}
