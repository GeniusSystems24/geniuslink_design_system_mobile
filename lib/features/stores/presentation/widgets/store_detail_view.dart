...
/// Presentation view extracted from `StoreDetailScreen`.
///
...
class StoreDetailView extends StatelessWidget {
  ...
  const StoreDetailView({required this.store, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return FeaturePageScaffold(
      title: Text(GeniusLinkLocalization.of(context).storeDetail),
