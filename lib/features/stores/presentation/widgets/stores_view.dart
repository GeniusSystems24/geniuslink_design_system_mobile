...
/// Presentation view extracted from `StoresScreen`.
///
...
class StoresView extends StatelessWidget {
  ...
  const StoresView({required this.stores, this.onStoreSelected, super.key});

  @override
  Widget build(BuildContext context) {
    return FeaturePageScaffold(
      title: Text(GeniusLinkLocalization.of(context).stores),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (store.localizedName
                                case final localizedName?) ...[
                    ...
                    child: Row(
                      children: [
                        _stat(
                          context,
                          'Value',
                          '${SuperFormat.number(store.stockValue, decimals: 0)} SAR',
                        ),
                        const SizedBox(width: 20),
                        _stat(
                          context,
                          'SKUs',
                          SuperFormat.number(store.skuCount, decimals: 0),
                        ),
                      ],
                    ),
                  ),
