...
/// Renders the presentation for [ExchangeRateSetupScreen].
///
...
///
/// ```dart
/// const ExchangeRateSetupView()
/// ```
class ExchangeRateSetupView extends StatelessWidget {
  const ExchangeRateSetupView({super.key});
  @override
