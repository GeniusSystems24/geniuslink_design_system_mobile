          ...
          child: SuperGrid(
            ...
            children: [
              ...
              SuperGridCell(
                ...
                desktop: 6,
                large: 6,
                child: KeyValueRow(l10n.accountType, l10n.assetCashEquivalents),
              ),
              SuperGridCell(
                mobile: 4,
                tablet: 4,
                desktop: 6,
                large: 6,
                child: KeyValueRow(l10n.nameEnglish, 'Cash Box'),
              ),
              SuperGridCell(
                mobile: 4,
                tablet: 4,
                desktop: 6,
                large: 6,
                child: KeyValueRow(l10n.nameArabic, 'الصندوق', ar: true),
              ),
              SuperGridCell(
                mobile: 4,
                tablet: 4,
              ...
              SuperGridCell(
                ...
                desktop: 6,
                large: 6,
                child: KeyValueRow(l10n.currency, 'SAR — Saudi Riyal'),
              ),
              SuperGridCell(
                mobile: 4,
                tablet: 4,
                desktop: 6,
                large: 6,
                child: KeyValueRow(l10n.parentGroup, 'Current Assets (1000)'),
              ),
              SuperGridCell(
                mobile: 4,
                tablet: 4,
                desktop: 6,
                large: 6,
                child: KeyValueRow(l10n.tenantId, '9', mono: true),
              ),
            ],
          ),
        ),
