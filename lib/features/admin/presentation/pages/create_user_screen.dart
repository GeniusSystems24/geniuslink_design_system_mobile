...
class CreateUserScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MScroll([
      ISection(icon: MIcons.of('user'), title: 'Identity', sub: "The new member's name and contact", marker: SuperMaterialThemeData.of(context).colorScheme.primary, children: const [
      ...
      ISection(icon: MIcons.of('lock'), title: 'Access', sub: 'Role determines default permissions', marker: SuperMaterialThemeData.of(context).colorScheme.secondary, children: [
