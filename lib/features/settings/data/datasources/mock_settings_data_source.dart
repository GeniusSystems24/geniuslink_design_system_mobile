...
abstract final class MockSettingsDataSource {
  static const notificationCategories = <NotificationCategory>[
    NotificationCategory(
      id: 'ledger',
      title: 'Postings & Ledger',
      description: 'Entries posted, reversed',
    ),
    NotificationCategory(
      id: 'approvals',
      title: 'Approvals',
      description: 'Wires & adjustments',
    ),
    NotificationCategory(
      id: 'inventory',
      title: 'Inventory',
      description: 'Low stock, transfers',
    ),
    NotificationCategory(
      id: 'security',
      title: 'Security',
      description: 'Sign-ins, key changes',
    ),
    NotificationCategory(
      id: 'billing',
      title: 'Billing',
      description: 'Invoices & usage',
    ),
  ];

  static const notificationChannels = <NotificationChannel>[
  ...
  static const integrations = <IntegrationDefinition>[
    IntegrationDefinition(
      ...
      description: 'Sync chart of accounts and journals',
    ...
    IntegrationDefinition(
      id: 'stripe',
      name: 'Stripe',
      description: 'Card payments and settlements',
    ...
    IntegrationDefinition(
      id: 'shopify',
      name: 'Shopify',
      description: 'Orders and inventory sync',
      category: IntegrationCategory.operations,
    ),
    IntegrationDefinition(
      id: 'slack',
      name: 'Slack',
