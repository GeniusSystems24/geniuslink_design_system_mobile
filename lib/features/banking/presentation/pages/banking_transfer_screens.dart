...
class CreateLocalTransferScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MScroll([
      const ISection(icon: 'swap', title: 'Transfer Amount', marker: M.blue, children: [
        MMoney(label: 'Amount', value: '50,000.00', accent: M.blue, required: true),
      ]),
      const ISection(icon: 'building', title: 'Accounts', marker: M.green, children: [
...
class LocalTransferDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MScroll([
      MCard(marker: M.blue, title: 'Inter-Account Settlement', right: const Pill('Posted'), children: const [
        Text('TR-2024-9042 · Dec 18, 2025', style: TextStyle(fontFamily: M.mono, fontSize: 12, color: M.blue)),
      ]),
      const MCard(marker: M.blue, title: 'Flow', pad: 16, children: [
        FromToFlow(
          from: FlowCardData(label: 'From', title: 'Bank · NCB Main', sub: '1100', meta: 'Balance after  ·  136,420.00'),
          to: FlowCardData(label: 'To', title: 'Bank · Al Rajhi', sub: '1101', meta: 'Balance after  ·  56,240.00', metaColor: M.green),
        ),
      ]),
      const MCard(marker: M.green, title: 'Amount', children: [
...
class CreateExternalTransferScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MScroll([
      const ISection(icon: 'globe', title: 'Transfer Amount', marker: M.orange, children: [
        MMoney(label: 'Amount', value: '11,000.00', currency: 'USD', accent: M.orange, required: true),
      ]),
      const ISection(icon: 'percent', title: 'FX Conversion', marker: M.blue, children: [
        FxTiles(tiles: [
      ...
      const ISection(icon: 'building', title: 'Beneficiary', marker: M.green, children: [
        IField(label: 'From Account', value: 'Bank · NCB Main (1100)', select: true, required: true),
...
class ExternalTransferDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MScroll([
      MCard(marker: M.orange, title: 'External Wire', right: const Pill('Pending', tone: PillTone.warning), children: const [
        Text('EXT-2024-0311 · Dec 18, 2025', style: TextStyle(fontFamily: M.mono, fontSize: 12, color: M.blue)),
      ]),
      const MCard(marker: M.orange, title: 'Amount & FX', children: [
      ...
      const MCard(marker: M.green, title: 'Beneficiary', children: [
