...
class CreateDepositScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MScroll([
      ISection(icon: MIcons.of('download'), title: 'Deposit Amount', accentColor: SuperMaterialThemeData.of(context).colorScheme.secondary, children: [
      ...
      ISection(icon: MIcons.of('card'), title: 'Destination', accentColor: SuperMaterialThemeData.of(context).colorScheme.primary, children: const [
