...
/// const OpDetailView()
/// ```
class OpDetailView extends StatelessWidget {
  const OpDetailView({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: SuperAppBar(
        title: Text(GeniusLinkLocalization.of(context).financialOperation),
