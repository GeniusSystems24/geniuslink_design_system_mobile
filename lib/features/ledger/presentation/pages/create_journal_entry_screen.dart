...
class CreateJournalEntryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: MScroll([
        ISection(icon: MIcons.of('doc'), title: 'Entry Header', accentColor: SuperMaterialThemeData.of(context).colorScheme.primary, children: const [IField(label: 'Serial No', value: 'JV-2024-0227', mono: true, locked: true), IField(label: 'Date', value: 'Dec 19, 2025', icon: 'calendar'), IField(label: 'Currency', value: 'SAR — Saudi Riyal', select: true), ITextarea(label: 'Description', placeholder: 'Describe this journal entry…')]),
        ISection(icon: MIcons.of('ledger'), title: 'Journal Lines', accentColor: SuperMaterialThemeData.of(context).colorScheme.secondary, sub: '${lines.length} lines', children: [
