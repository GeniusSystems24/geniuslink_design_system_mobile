...
class MAppBar extends StatelessWidget {
  ...
  final Widget? action;
  const MAppBar(
      {super.key, required this.title, this.ar, this.onBack, this.action});
        ...
        if (onBack != null)
          GestureDetector(
              ...
              child: const Padding(
                  ...
                  child:
                      Icon(Icons.arrow_back_rounded, size: 22, color: M.blue))),
        Expanded(
            child:
          ...
          Expanded(
            ...
            child: Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Icon(MIcons.of(icon),
                      size: 22, color: active == id ? M.blue : M.fg3),
                  ...
                  Text(label,
                      style: TextStyle(
                          ...
                          fontSize: 10,
                          fontWeight:
                              active == id ? FontWeight.w700 : FontWeight.w500,
                          color: active == id ? M.blue : M.fg3)),
                ])),
          )),
      ]),
    );
