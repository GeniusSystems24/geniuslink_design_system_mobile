  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: SuperMaterialThemeData.of(context).superTheme.bg.withAlpha(0xEB),
        border: Border(
          bottom: BorderSide(
    ...
    return Container(
      decoration: BoxDecoration(
        color: SuperMaterialThemeData.of(
          context,
        ).bottomNavigationBarTheme.backgroundColor?.withAlpha(0xE6),
        border: Border(
          top: BorderSide(
            color: SuperMaterialThemeData.of(context).superTheme.border,
          ),
